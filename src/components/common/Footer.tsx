...
import Linkedin_Icon_Orange from "@components/icons/Linkedin_Icon_Orange";
        ...
        <div className="grid grid-cols-4 my-16 gap-44">
          ...
          <div className=" w-full pl-8">
            ...
            <ul className="list-none">
              <li className="mb-3">
                <Link
                  href={"mailto:info@connextar.com"}
                  className="text-[var(--medium-gray)] hover:text-white text-[17px]"
                >
                  info@connextar.com
                </Link>
              </li>
              <li className="mb-3">
                <Link href={"tel:+447968579492"} className="text-[var(--medium-gray)] hover:text-white text-[17px]">
                  (+44) (0) 7968579492
                </Link>
              </li>
              <li className="mb-3">
                <Link
                  href={"https://connextar.com/contact"}
                  target={"_blank"}
                  className="text-[var(--medium-gray)] hover:text-white text-[17px]"
                >
                  Contact
